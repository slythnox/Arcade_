...
export const faqs: FAQItem[] = [
  {
    ...
    answer: "ARCADE_ is a modern, browser-based retro gaming platform featuring 62 mathematically pure cartridge games. It is built completely from scratch using web standards, relying on zero ROMs or third-party emulators, and operates directly in your browser with zero dependencies.",
    category: "general"
  },
  {
    id: "is-it-free",
  ...
  },
  {
    ...
    answer: "There are precisely 62 unique games built into the platform, meticulously categorized into 7 distinct tiers ranging from Core Classics like Tetris and Snake, up to complex Strategy, Racing, and Experimental concepts.",
    category: "general"
  },
  {
