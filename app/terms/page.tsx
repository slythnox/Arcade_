      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gap: '2rem' }}>
          ...
          <section style={cardStyle('var(--arcade-green, #63E66D)')}>
            ...
            <p>
              All 62 deterministic cartridges available on this platform are original, from-scratch TypeScript implementations. We do not host, distribute, or run emulated ROMs of copyrighted classic arcade titles. Every line of game logic has been freshly synthesized for the modern web.
            </p>
          </section>
